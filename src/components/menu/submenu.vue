<template>
  <li  
    ...
    <transition v-else name='slode-up'>
      <Drop v-show='opened' ref='drop' :style='dropStyle'>
...
import CollapseTransition from '@/components/base/collapse-transiton';
...
export default {
  ...
  components: { CIcon, Drop, CollapseTransition },
  props: {
    name: {
      type: [String, Number],
      required: true
